...
function renderRecommendations(container, results) {
    ...
    html += '<div class="recs-collapsible"><button class="recs-collapsible-toggle" id="recsGridToggle"><span class="recs-collapsible-arrow">▶</span> 🎯 ' + T('recsSubtabRecommendations', 'Recommendations') + ' (<span id="recsGridCount">0</span> ' + T('recsItems', 'items') + ')</button>';
