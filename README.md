...
| **🤖 Smart Recommendations** | ML-powered per-user recommendations with three-tier scoring (heuristic + learned + ensemble blend). Analyses watch history to build genre affinity profiles and scores unwatched candidates using 11 features including collaborative filtering, recency, ratings, and interaction terms |
